...
export const AdvisorChat: React.FC<AdvisorChatProps> = ({ profile }) => {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', text: `Hey ${profile.name}! I'm Finny, your personal financial guide. What can I help you master today? We could talk about your current net worth of $${profile.totalBalance.toLocaleString()}, how compound interest works, or even global market trends! 📈` }
  ]);
