  ...
  return (
    <div className="space-y-10 animate-fadeIn pb-12">
      <header>
        ...
        <p className="text-slate-500 mt-2 text-lg font-medium">Stress-test your current portfolio against history's greatest crashes.</p>
      </header>
              ...
              {result && !isLoading && (
                <div className="animate-fadeIn h-full flex flex-col">
                   ...
                   <div className="mt-10 p-6 bg-white/5 rounded-3xl border border-white/5 flex items-center gap-6">
                      ...
                      <div>
                        <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Strategic Takeaway</div>
