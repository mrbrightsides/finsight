    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-indigo-100 font-serif">
      ...
      <div className="max-w-4xl mx-auto px-8 py-20">
        ...
        <div className="space-y-24">
          {/* Section 1 */}
          <section>
            <h2 className="font-sans text-xs font-black text-indigo-600 uppercase tracking-[0.4em] mb-8">01. The Mission</h2>
            <div className="prose prose-slate max-w-none prose-lg text-slate-700 leading-relaxed">
              <p>
                FinSight AI is founded on a singular premise: <strong>economic literacy is a survival skill.</strong> In an era where algorithmic trading and digital assets define the baseline of financial participation, individuals require more than static spreadsheets—they require intelligence agents.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none prose-lg text-slate-700 leading-relaxed">
              <p>
                FinSight AI is not a broker; it is a <strong>Cognitive Amplifier</strong> for the economic mind. As we move forward, the engine will evolve to include multi-agent simulations where users can compete in "Learning Combat" within the Knowledge Arena, fostering a community of enlightened strategists.
              </p>
